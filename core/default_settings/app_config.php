<?php
	...
	//default settings
		...
		$apps[$x]['default_settings'][$y]['default_setting_description'] = "";
		$y++;
		$apps[$x]['default_settings'][$y]['default_setting_uuid'] = 'cb55e6ac-9bb0-4714-b68f-82b39a3b9ec4';
                $apps[$x]['default_settings'][$y]['default_setting_category'] = 'domain';
                $apps[$x]['default_settings'][$y]['default_setting_subcategory'] = 'domain_language';
                $apps[$x]['default_settings'][$y]['default_setting_name'] = 'code';
                $apps[$x]['default_settings'][$y]['default_setting_value'] = 'en';
                $apps[$x]['default_settings'][$y]['default_setting_enabled'] = 'true';
                $apps[$x]['default_settings'][$y]['default_setting_description'] = '';
                $y++;
		$apps[$x]['default_settings'][$y]['default_setting_uuid'] = 'cb55e6ac-9bb0-4714-b68f-82b39a3b9ec5';
                $apps[$x]['default_settings'][$y]['default_setting_category'] = 'domain';
                $apps[$x]['default_settings'][$y]['default_setting_subcategory'] = 'domain_dialect';
                $apps[$x]['default_settings'][$y]['default_setting_name'] = 'code';
                $apps[$x]['default_settings'][$y]['default_setting_value'] = 'us';
                $apps[$x]['default_settings'][$y]['default_setting_enabled'] = 'true';
                $apps[$x]['default_settings'][$y]['default_setting_description'] = '';
                $y++;
		$apps[$x]['default_settings'][$y]['default_setting_uuid'] = 'cb55e6ac-9bb0-4714-b68f-82b39a3b9ec6';
                $apps[$x]['default_settings'][$y]['default_setting_category'] = 'domain';
                $apps[$x]['default_settings'][$y]['default_setting_subcategory'] = 'domain_voice';
                $apps[$x]['default_settings'][$y]['default_setting_name'] = 'code';
                $apps[$x]['default_settings'][$y]['default_setting_value'] = 'callie';
                $apps[$x]['default_settings'][$y]['default_setting_enabled'] = 'true';
                $apps[$x]['default_settings'][$y]['default_setting_description'] = '';
                $y++;
