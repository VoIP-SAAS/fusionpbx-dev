...
//set the action as an add or an update
	...
	if (count($_POST) > 0) {
		...
		$switch_name				=	$_POST['switch_name'];
				...
				$msg = '';
				if (strlen($name) == 0) { $msg .= $text['message-required']." ".$text['label-form-name']."<br>\n"; }
				if (strlen($hostname) == 0) { $msg .= $text['message-required']." ".$text['label-form-hostname']."<br>\n"; }
				if (strlen($virtualhost) == 0) { $msg .= $text['message-required']." ".$text['label-form-virtualhost']."<br>\n"; }
				if (strlen($username) == 0) { $msg .= $text['message-required']." ".$text['label-form-username']."<br>\n"; }
				if (strlen($password) == 0) { $msg .= $text['message-required']." ".$text['label-form-password']."<br>\n"; }
				if (strlen($port) == 0) { $msg .= $text['message-required']." ".$text['label-form-port']."<br>\n"; }
